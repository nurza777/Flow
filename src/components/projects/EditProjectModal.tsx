...
export default function EditProjectModal({ projectId, onClose }: EditProjectModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/30 backdrop-blur-sm">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-lg max-h-[90vh] flex flex-col">
        <div className="flex items-center justify-between p-5 border-b border-slate-200 flex-shrink-0">
          <h2 className="text-lg font-semibold text-slate-900">Редактировать проект</h2>
          <button
            onClick={onClose}
              ...
              {tab === "description" && (
                <>
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mb-2">Архитектура, стек, соглашения, правила</p>
                    <textarea
                      value={longDesc}
